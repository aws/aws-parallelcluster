...
@tags(["Cluster Logs"])
@documentation("Retrieve the events associated with a log stream.")
operation GetClusterLogEvents {
    input: GetClusterLogEventsRequest,
...
structure GetClusterLogEventsRequest {
    @httpLabel
    @required
