...
def lazy_import():
    ...
    globals()['Ec2AmiInfoSummary'] = Ec2AmiInfoSummary
    globals()['ImageBuildStatus'] = ImageBuildStatus


class ImageInfoSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_id, region, version, image_build_status, *args, **kwargs):  # noqa: E501
