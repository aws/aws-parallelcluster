...
class DescribeImageResponseContent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_id, region, version, image_build_status, image_configuration, *args, **kwargs):  # noqa: E501
