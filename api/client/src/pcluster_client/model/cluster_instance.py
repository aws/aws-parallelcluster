...
class ClusterInstance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, instance_id, instance_type, launch_time, private_ip_address, state, node_type, *args, **kwargs):  # noqa: E501
