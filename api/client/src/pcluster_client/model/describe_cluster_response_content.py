...
def lazy_import():
    ...
    from pcluster_client.model.detail import Detail
...
class DescribeClusterResponseContent(ModelNormal):
    ...
    def _from_openapi_data(cls, cluster_name, region, version, cloud_formation_stack_status, cluster_status, cloudformation_stack_arn, creation_time, last_updated_time, cluster_configuration, compute_fleet_status, tags, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            details ([Detail]): Detailed information about the cluster, provided only when the 'verbose' flag is set to true.. [optional]  # noqa: E501
        """
