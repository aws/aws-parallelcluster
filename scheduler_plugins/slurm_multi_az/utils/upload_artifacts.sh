...
ADDITIONAL_CLUSTER_INFRASTRUCTURE_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm_multi_az/slurm_plugin_infrastructure.cfn.yaml"
echo "Uploading slurm_plugin_infrastructure.cfn.yaml to ${ADDITIONAL_CLUSTER_INFRASTRUCTURE_S3_URL}"
aws s3 cp ./slurm_plugin_infrastructure.cfn.yaml "${ADDITIONAL_CLUSTER_INFRASTRUCTURE_S3_URL}"

PLUGIN_DEFINITION_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm_multi_az/plugin_definition.yaml"
...
PLUGIN_ARTIFACTS_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm_multi_az/artifacts.tar.gz"
...
GENERATED_CONFIG_PATH="/tmp/slurm_multi_az_plugin_cluster_config.yaml"
...
echo "  pcluster create-cluster --region ${AWS_REGION} --cluster-configuration ${GENERATED_CONFIG_PATH} --rollback-on-failure false --cluster-name multi-az-test-cluster"
