...
ADDITIONAL_CLUSTER_INFRASTRUCTURE_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm/slurm_plugin_infrastructure.cfn.yaml"
...
PLUGIN_DEFINITION_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm/plugin_definition.yaml"
...
PLUGIN_ARTIFACTS_S3_URL="s3://${S3_BUCKET}/scheduler_plugins/slurm/artifacts.tar.gz"
