...
def _get_parser():
    ...
    parser.add_argument('instance_ids', help='A space separated list of instances IDs. If a single instance is '
...
class Host(object):
    ...
    Generic host object.
    """
    def __init__(self, container_instance_arn, status, ec2_instance, instance_type, private_ip_address,
                 public_ip_address, private_dns_name, public_dns_name, running_jobs, pending_jobs):
...
class AWSBhostsCommand(object):
    ...
    def run(self, compute_environments, show_details=False, instance_ids=None):
        ...
        if show_details or instance_ids:
            ...
            self.output.show_table(['ec2InstanceId', 'instanceType', 'privateIpAddress',
    ...
    def __create_host_item(container_instance, ec2_instance):
        ...
        try:
            ...
            return Host(container_instance_arn=container_instance['containerInstanceArn'],
    ...
    def _add_host_items(self, ecs_cluster_arn, container_instances_arns, instance_ids=None):
        ...
        if container_instances_arns:
            response = self.ecs_client.describe_container_instances(cluster=ecs_cluster_arn,
    ...
    def __get_ecs_clusters(self, compute_environments):
        ...
        try:
            ...
            while next_token is not None:
                response = batch_client.describe_compute_environments(computeEnvironments=compute_environments,
