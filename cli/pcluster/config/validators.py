...
def fsx_validator(section_key, section_label, pcluster_config):
    ...
    validate_backup_options(errors, fsx_automatic_backup_retention_days, fsx_daily_automatic_backup_start_time,
        fsx_copy_tags_to_backups, fsx_deployment_type, fsx_imported_file_chunk_size, fsx_import_path, fsx_export_path, fsx_auto_import_policy)
    return errors, warnings
...
def get_bucket_name_from_s3_url(importPath):
...
def validate_backup_options(errors, fsx_automatic_backup_retention_days, fsx_daily_automatic_backup_start_time,
        fsx_copy_tags_to_backups, fsx_deployment_type, fsx_imported_file_chunk_size, fsx_import_path, fsx_export_path, fsx_auto_import_policy):
