...
import base64
import pytest
from pcluster.cli.entrypoint import gen_parser, APIOperationException, ParameterException
...
def identity_dispatch(mocker):
    def _identity(body, **kwargs):
        ...
        ret.update(kwargs)
        return ret
    mocker.patch('pcluster.cli.model.get_function_from_name',
...
class TestCliModel:
    ...
    def test_middleware(self, mocker, identity_dispatch):
        ...
        mocker.patch('pcluster.cli.entrypoint.middleware_hooks',
                     return_value={'op': op_middle})
