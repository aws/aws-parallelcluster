...
class TestDescribeImageCommand:
    ...
    def test_execute(self, mocker):
        response_dict = {
            ...
            "imageId": "aws-parallelcluster-3-0-0-ubuntu-2404-lts-hvm-arm64-202101010000",
            "creationTime": "2021-01-01T00:00:00.000Z",
            "imageBuildStatus": "BUILD_COMPLETE",
            "region": "eu-west-2",
            "ec2AmiInfo": {
                "amiName": "aws-parallelcluster-3.0.0-ubuntu-2404-lts-hvm-x86_64-202101010000 2021-01-01T00-00-00.000Z",
                "amiId": "ami-FEED0DEAD0BEEF000",
                "description": "AWS ParallelCluster AMI for ubuntu2404",
                "state": "AVAILABLE",
                "tags": [
