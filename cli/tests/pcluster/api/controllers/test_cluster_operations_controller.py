    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                None,
                {
                    "message": "Bad Request: invalid cluster configuration. "
                    "Please make sure the string is base64 encoded."
                },
            ),
            (
                ...
                None,
                None,
                {"message": "Bad Request: cluster configuration must be a valid base64-encoded YAML document"},
            ),
            (
                {
            ...
            (
                ...
                None,
                None,
                {"message": "Bad Request: cluster configuration is required and cannot be empty"},
            ),
            (
                {"clusterConfiguration": "", "name": "cluster", "region": "us-east-1"},
                None,
