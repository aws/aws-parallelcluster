...
def test_get_path_n_name_prefix_from_iam_resource_prefix(resource_prefix, expected_output):
    iam_path_prefix, iam_role_prefix = utils.get_path_n_name_prefix_from_iam_resource_prefix(
