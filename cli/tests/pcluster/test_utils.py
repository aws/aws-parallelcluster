...
@pytest.mark.parametrize(
    ...
    [
        ("x86_64", ["alinux", "alinux2", "centos7", "centos8", "ubuntu1804"]),
...
@pytest.mark.parametrize(
    ...
    [
        ("sge", ["alinux", "alinux2", "centos7", "centos8", "ubuntu1804"]),
        ("slurm", ["alinux", "alinux2", "centos7", "centos8", "ubuntu1804"]),
        ("torque", ["alinux", "alinux2", "centos7", "centos8", "ubuntu1804"]),
        ("awsbatch", ["alinux2", "alinux"]),
        # doesn't check architecture's validity, only whether it's awsbatch or not
        ("madeup-scheduler", ["alinux", "alinux2", "centos7", "centos8", "ubuntu1804"]),
    ],
)
