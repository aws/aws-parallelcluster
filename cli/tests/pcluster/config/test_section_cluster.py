...
@pytest.mark.parametrize(
    ...
    [
        ("default", utils.merge_dicts(DefaultCfnParams["cluster_sit"].value, {"Scheduler": "slurm"})),
        (
            "custom1",
            utils.merge_dicts(
                DefaultCfnParams["cluster_sit"].value,
                {
                    ...
                    "MasterRootVolumeSize": "1000",
                    "ComputeInstanceType": "t2.large",
                    "ComputeRootVolumeSize": "1000",
                    "DesiredSize": "1",
                    "MaxSize": "2",
                    "MinSize": "1",
                    "ClusterType": "spot",
        ...
        (
            "cw_log",
            utils.merge_dicts(DefaultCfnParams["cluster_sit"].value, {"CWLogOptions": "true,1", "Scheduler": "slurm"}),
        ),
        (
            "all-settings",
            utils.merge_dicts(
