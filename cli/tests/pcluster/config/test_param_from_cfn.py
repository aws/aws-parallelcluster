...
@pytest.mark.parametrize(
    ...
    [
        ...
        # IntParam
        (CLUSTER_SIT, "master_root_volume_size", {"MasterRootVolumeSize": "10"}, 10),
        (CLUSTER_SIT, "master_root_volume_size", {"MasterRootVolumeSize": "NONE"}, 35),
        (CLUSTER_SIT, "master_root_volume_size", {"MasterRootVolumeSize": "wrong_value"}, 35),
        # JsonParam
