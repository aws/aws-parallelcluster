...
COOKBOOK_PACKAGES_VERSIONS = {
    ...
    "cookbook": "aws-parallelcluster-cookbook-3.3.0",
    "chef": "17.2.29",
    "berkshelf": "7.2.0",
    "ami": "dev",
}
...
IAM_RESOURCE_PREFIX_REGEX = "[a-zA-Z0-9_/+=,.@-]"
IAM_RESOURCE_PREFIX_FINAL_REGEX = (
    r"^/" + IAM_RESOURCE_PREFIX_REGEX + "+/{1,512}$|^/" + IAM_RESOURCE_PREFIX_REGEX + "{1,512}$|^" + "[a-zA-Z0-9_+=,.@-]{1,64}$"
)
