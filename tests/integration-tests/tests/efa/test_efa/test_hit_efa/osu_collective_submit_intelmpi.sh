...
mpirun -np ${NUM_OF_PROCESSES} -bootstrap=slurm /shared/intelmpi/osu-micro-benchmarks-${OSU_BENCHMARK_VERSION}/mpi/collective/${BENCHMARK_NAME} > /shared/${BENCHMARK_NAME}.out
