...
def _test_cloud_node_health_check(
    ...
    metric_names = ["EC2 Health Check"]
    unique_names = [cluster_name + "." + metric_names]
    period_sec = 60
    collection_time_min = 12
    response = retrieve_metric_data(unique_names, cluster_name, metric_names, period_sec, collection_time_min)
...
def _test_ec2_status_check_replacement(
    ...
    # Get Error Metric
    metric_names = ["Slurm Health Check Failure"]
    unique_names = [cluster_name + "." + metric_names]
    period_sec = 60
...
def _test_disable_protected_mode(
    ...
    metric_names = ["Error With Custom Script"]
    unique_names = [cluster.name + "." + metric_names]
    period_sec = 60
    collection_time_min = 8
    response = retrieve_metric_data(unique_names, cluster.name, metric_names, period_sec, collection_time_min)
