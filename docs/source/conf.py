# -*- coding: utf-8 -*-
#
# cfncluster documentation build configuration file, created by
...
copyright = u'2014-2016, Amazon Web Services'
...
man_pages = [
    ('index', 'cfncluster', u'cfncluster Documentation',
     [u'Dougal Ballantyne'], 1)
]
...
texinfo_documents = [
  ('index', 'cfncluster', u'cfncluster Documentation',
   u'Dougal Ballantyne', 'cfncluster', 'One line description of project.',
   'Miscellaneous'),
]
