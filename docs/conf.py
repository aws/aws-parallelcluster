# -*- coding: utf-8 -*-
#
# AWS ParallelCluster documentation build configuration file, created by
...
html_title = "AWS ParallelCluster %s" % release
...
htmlhelp_basename = 'aws-parallelcluster-doc'
...
html_theme_options = {
    ...
    "project_nav_name": "AWS ParallelCluster",
    # Set your GitHub user and repo to enable GitHub stars links
    "github_user": "aws",
    "github_repo": "aws-parallelcluster",
...
latex_documents = [
  ('index', 'aws-parallelcluster.tex', u'AWS ParallelCluster Documentation',
   u'Amazon Web Services', u'Amazon Web Services', 'manual'),
]
...
man_pages = [
    ('index', 'aws-parallelcluster', u'AWS ParallelCluster Documentation',
...
texinfo_documents = [
  ('index', 'aws-parallelcluster', u'AWS ParallelCluster Documentation',
   u'Amazon Web Services', 'aws-parallelcluster', 'One line description of project.',
   'Miscellaneous'),
]
